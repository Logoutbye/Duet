...
// import 'package:duet/src/features/duet/widgets/animatedbutton.dart';
...
//     print(':::Recorded video path: $recordedPath');
//     print(':::Picked video path: $pickedPath');
...
//         // Retry merging with adjusted parameters if necessary
...
//   //     String outputPath, String recordedPath, String pickedPath) async {
//   //   print(
//   //       ':::_________________________________started merging________________________');
//   //   print('::: recordedPath$recordedPath ');
//   //   print(':::pickedPath $pickedPath ');
//   //   // Normalize both videos to the same resolution
//   //   const filter =
//   //       "[0:v]scale=480:640,setsar=1[l];[1:v]scale=480:640,setsar=1[r];[l][r]hstack=inputs=2[v]";
...
//   //       print("::: Error: $failStackTrace");
//   //       print(
//   //           ':::_________________________________Re-started merging________________________');
...
//         print("::: Error: $failStackTrace");
//         print(
//             ':::_________________________________Re-started merging failed________________________');
